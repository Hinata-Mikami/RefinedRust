...
Definition to_dfrac_agree {SI : sidx} {A : ofe} (dq : dfrac) (a : A) : dfrac_agreeR A :=
  (dq, to_agree a).
...
Section lemmas.
  ...
  Global Instance to_dfrac_agree_ne dq : NonExpansive (@to_dfrac_agree SI A dq).
  Proof. solve_proper. Qed.
  Global Instance to_dfrac_agree_proper dq : Proper ((≡) ==> (≡)) (@to_dfrac_agree SI A dq).
  Proof. solve_proper. Qed.
  ...
  Proof. apply _. Qed.
  Global Instance to_frac_injN n : Inj2 (dist n) (dist n) (dist n) (@to_dfrac_agree SI A).
  Proof. by intros dq1 a1 dq2 a2 [??%(inj to_agree)]. Qed.
  Global Instance to_dfrac_inj : Inj2 (≡) (≡) (≡) (@to_dfrac_agree SI A).
  Proof. by intros dq1 a1 dq2 a2 [??%(inj to_agree)]. Qed.
