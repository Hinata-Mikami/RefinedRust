...
Definition tuple1_ty `{!refinedrustGS Σ} (T0_rt : Type) : spec_with 0 [T0_rt] (type (tuple1_rt _)) :=
...
Definition tuple2_ty `{!refinedrustGS Σ} (T0_rt T1_rt : Type) : spec_with 0 [T0_rt; T1_rt] (type (tuple2_rt _ _)) :=
...
Definition tuple3_ty `{!refinedrustGS Σ} (T0_rt T1_rt T2_rt : Type) : spec_with 0 [T0_rt; T1_rt; T2_rt] (type (tuple3_rt _ _ _)) :=
...
Definition tuple4_ty `{!refinedrustGS Σ} (T0_rt T1_rt T2_rt T3_rt : Type) : spec_with 0 [T0_rt; T1_rt; T2_rt; T3_rt] (type (tuple4_rt _ _ _ _)) :=
...
Definition tuple5_ty `{!refinedrustGS Σ} (T0_rt T1_rt T2_rt T3_rt T4_rt : Type) : spec_with 0 [T0_rt; T1_rt; T2_rt; T3_rt; T4_rt] (type (tuple5_rt _ _ _ _ _)) :=
