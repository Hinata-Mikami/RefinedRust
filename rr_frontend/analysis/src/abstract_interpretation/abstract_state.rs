...
///     - for every ascending chain of domain elements `x_i` the ascending chain `y_i` defined as `y_0 :=
///       x_0`, `y_(i+1) := x_i.widen(y_i)` reaches a fixed-point after a finite number of steps
