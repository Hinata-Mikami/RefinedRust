...
Definition traits_iterator_Iterator_Next_sig `{RRGS : !(refinedrustGS Σ)} (Self_rt: RT) (Item_rt: RT) (traits_iterator_Iterator_Inv: (traits_iterator_Iterator_Inv_sig (Self_rt) (Item_rt))) :=
  (thread_id → (RT_xt (Self_rt)) → option (RT_xt (Item_rt)) → (RT_xt (Self_rt)) → iProp Σ).
Record traits_iterator_Iterator_spec_attrs `{RRGS : !(refinedrustGS Σ)} `{Self_rt : !RT} `{Item_rt : !RT} : Type := mk_traits_iterator_Iterator_spec_attrs {
  traits_iterator_Iterator_Inv  : (traits_iterator_Iterator_Inv_sig (Self_rt) (Item_rt));
  traits_iterator_Iterator_Next  : (traits_iterator_Iterator_Next_sig (Self_rt) (Item_rt) (traits_iterator_Iterator_Inv));
}.
