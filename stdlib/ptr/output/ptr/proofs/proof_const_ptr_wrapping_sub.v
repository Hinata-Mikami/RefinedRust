...
From stdlib.ptr.ptr.generated Require Import generated_code_ptr generated_specs_ptr generated_template_const_ptr_wrapping_sub.
...
Lemma const_ptr_wrapping_sub_proof (π : thread_id) :
  const_ptr_wrapping_sub_lemma π.
Proof.
  const_ptr_wrapping_sub_prelude.
  ...
  iApply (wp_ptr_wrapping_neg_offset_credits with "TIME Hat Hp").
  { done. }
  { apply val_to_of_loc. }
  { done. }
