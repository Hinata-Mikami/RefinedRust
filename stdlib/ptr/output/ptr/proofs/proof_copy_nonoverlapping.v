...
From stdlib.ptr.ptr.generated Require Import generated_code_ptr generated_specs_ptr generated_template_copy_nonoverlapping.
...
Proof.
  ...
  set (loop_inv := (λ (E : elctx) (L : llctx),
    ...
    (credit_store 0 0 ∗
    arg_arg_size ◁ₗ[π, Owned false] #size @ (◁ int usize_t) ∗
    local_count ◁ₗ[π, Owned false] #(Z.of_nat i) @ (◁ int usize_t) ∗
    arg_arg_src ◁ₗ[π, Owned false] #src @ (◁ alias_ptr_t) ∗
